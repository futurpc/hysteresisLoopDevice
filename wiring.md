...
| Source | Pi Pin # | Connect to |
|--------|----------|------------|
| 3.3V   | Pin 1    | power line (+) |
| GND    | Pin 6    | ground line (-) |

## AD9833 Waveform Generator (SPI0)

| Raspberry Pi | Pi Pin # | AD9833 Pin | Purpose |
|-------------|----------|------------|---------|
| SPI MOSI (GPIO 10) | Pin 19 | SDATA | SPI data |
| SPI SCLK (GPIO 11) | Pin 23 | SCLK | SPI clock |
| SPI CE0 (GPIO 8) | Pin 24 | FSYNC | Chip select |
...
| Raspberry Pi | Pi Pin # | MCP3208 Pin | Purpose |
|-------------|----------|-------------|---------|
| GPIO 18 | Pin 12 | pin 10 (CS/SHDN) | SPI1 chip select |
| GPIO 19 | Pin 35 | pin 12 (DOUT) | SPI1 MISO |
| GPIO 20 | Pin 38 | pin 11 (DIN) | SPI1 MOSI |
| GPIO 21 | Pin 40 | pin 13 (CLK) | SPI1 clock |
